...
import com.rupeelog.MainActivity
import com.rupeelog.R
import com.rupeelog.RupeeLogApp
...
class DashboardServerService : Service() {
    ...
    private fun createNotification(url: String): Notification {
        ...
        return NotificationCompat.Builder(this, RupeeLogApp.CHANNEL_SERVER)
    ...
    companion object {
        ...
        const val ACTION_START = "com.rupeelog.action.START_SERVER"
        const val ACTION_STOP = "com.rupeelog.action.STOP_SERVER"
    }
}
